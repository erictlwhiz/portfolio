    ...
    <div className="react-setup">
      ...
      <ol>
        ...
        <li>
          ...
          <p>Linting membantu menjaga kualitas kode. Jalankan perintah berikut:</p>
          <code>npm install --save-dev eslint prettier eslint-config-prettier eslint-plugin-react eslint-plugin-react-hooks</code>
        </li>
      </ol>
    </div>
  );
